...
module DHC
  autoload :BasicMethodsConcern,
    'dhc/concerns/dhc/basic_methods_concern'
  autoload :ConfigurationConcern,
    'dhc/concerns/dhc/configuration_concern'
  autoload :FixInvalidEncodingConcern,
    'dhc/concerns/dhc/fix_invalid_encoding_concern'
  autoload :FormatsConcern,
    'dhc/concerns/dhc/formats_concern'
  ...
  autoload :Auth,
    'dhc/interceptors/auth'
  autoload :Caching,
    'dhc/interceptors/caching'
  autoload :DefaultTimeout,
    'dhc/interceptors/default_timeout'
  autoload :Logging,
    'dhc/interceptors/logging'
  autoload :Prometheus,
    'dhc/interceptors/prometheus'
  autoload :Retry,
    'dhc/interceptors/retry'
  autoload :Throttle,
    'dhc/interceptors/throttle'
  ...
  autoload :ParserError,
    'dhc/errors/parser_error'
  autoload :ServerError,
    'dhc/errors/server_error'
  ...
  autoload :Format,
    'dhc/format'
  autoload :Monitoring,
    'dhc/interceptors/monitoring'
  autoload :Request,
    'dhc/request'
  autoload :Response,
    'dhc/response'
  autoload :Rollbar,
    'dhc/interceptors/rollbar'
  autoload :Zipkin,
    'dhc/interceptors/zipkin'
